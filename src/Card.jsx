...
const Card = () => {
  ...
  return (
    <div className='Cards'> {userList.map(user => ( 
      ...
      <div className="card-header">
        ...
        <h1 className="card-fullname" key={user.id}>{user.name}</h1>
        <h2 className="card-jobtitle" key={user.id}>{user.username}</h2>
      </div>
      <div className="card-main">
        <div className="card-section is-active" id="about" href='#about'>
          <div className="card-content" key={user.id}>
            <div className="card-subtitle" >Compagny : {user.company.name}
            <p className="card-desc">
           <b>The company's catchPhrase: </b> <br/>
            {user.company.catchPhrase} <br/>
            {user.company.bs}
            </p>
           </div>
          <div className="card-contact"  key={user.id} style={{textAlign:"left"}}>
                <svg
          ...
          <div className="card-contact" key={user.id}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="none"
